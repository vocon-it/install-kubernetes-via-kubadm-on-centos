...
echo "remove old jobs that were not completed (i.e. errored and pending jobs)"
...
echo "scale down old Pending intellij-desktops:"
...
echo "scale down obsolete idle-timeout deployments:"
